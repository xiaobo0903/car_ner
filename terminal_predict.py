...
model_dir = '/root/BERT-BiLSTM-CRF-NER/car'
bert_dir = '/root/BERT-BiLSTM-CRF-NER/chinese_L-12_H-768_A-12'
...
class Result(object):
    ...
    def append(self, word, start, end, tag):
        if tag == 'POW':
            self.loc.append(Pair(word, start, end, 'POW'))
        elif tag == 'PRI':
            self.loc.append(Pair(word, start, end, 'PRI'))
        elif tag == 'FOC':
            self.loc.append(Pair(word, start, end, 'FOC'))
        elif tag == 'FNAME':
            self.loc.append(Pair(word, start, end, 'FNA'))
        elif tag == 'BRA':
            self.loc.append(Pair(word, start, end, 'BRA'))
        elif tag == 'PAY':
            self.loc.append(Pair(word, start, end, 'PAY'))
        elif tag == 'MOD':
            self.loc.append(Pair(word, start, end, 'MOD'))
        elif tag == 'VEH':
            self.loc.append(Pair(word, start, end, 'VEH'))
        elif tag == 'GEN':
            self.loc.append(Pair(word, start, end, 'GEN'))
        elif tag == 'SPA':
            self.loc.append(Pair(word, start, end, 'SPA'))
        elif tag == 'PHO':
            self.loc.append(Pair(word, start, end, 'PHO'))
        elif tag == 'GAR':
            self.loc.append(Pair(word, start, end, 'GAR'))
        #else:
